...
try:
    ...
    with open('feedback.csv', mode='w' , encoding="utf-8" , newline='') as csv_file:
        ...
        for feedback in collection1.find():
            ...
            if(start_timestamp <=float(val_3) <=end_timestamp and val_7 == follow_up_type):
